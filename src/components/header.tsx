    ...
    <header className="bg-neutral-700 flex items-center gap-x-3">
      ...
      <div className="flex items-center justify-between w-full p-2">
        ...
        <div className="flex items-center gap-x-4 ">
          ...
          <button className="bg-primary text-primary-foreground p-2.5 md:size-fit flex items-center justify-center rounded-md md:px-4 md:py-2 hover:bg-primary-hover transition-colors duration-150 cursor-pointer">
            <SaveIcon />
